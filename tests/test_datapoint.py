...
class TestDataPoint(TestCase):
    def setUp(self) -> None:
        ...
        self.data_point_row = [time_ms, class_label, mean_id_interval, variance_id_frequency, num_id_transitions,
                               num_ids,
        ...
        self.header = ["time_ms", "class_label", "mean_id_interval", "variance_id_frequency", "num_id_transitions",
                       "num_ids", "num_msgs", "mean_id_intervals_variance", "mean_data_bit_count",
                       "variance_data_bit_count", "mean_variance_data_bit_count_id", "kurtosis_id_interval",
                       "kurtosis_id_frequency", "skewness_id_frequency", "kurtosis_mean_id_intervals",
                       "kurtosis_variance_data_bit_count_id", "skewness_id_interval_variances"]
